          ...
          {navigationTabs.map((tab) => {
            ...
            return (
              <div
                ...
                className={`relative cursor-pointer flex items-center flex-1 h-9 min-w-0 transition-all duration-200 hover:scale-105`}
                role="tab"
              ...
              >
                ...
                >
                  {Icon ? <Icon size={12} style={{ color: isActive ? '#FFFFFF' : COLORS.GREEN_PRIMARY }} /> : null}
                </div>

                <span
                  className={`absolute flex items-center justify-center left-12 right-2 transition-all duration-200 text-center overflow-hidden text-ellipsis whitespace-nowrap text-[14px] leading-[18px] ${isActive ? 'font-bold scale-[1.05]' : 'font-normal'}`}
