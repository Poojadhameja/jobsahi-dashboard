                ...
                <div className="p-6">
                    ...
                    <div className="flex gap-3">
                        <button
                            onClick={handleCancel}
                            disabled={isLoading}
                            className={`flex-1 h-11 rounded-lg font-medium border border-gray-300 text-gray-700 hover:bg-gray-50 transition-colors duration-200 ${isLoading ? 'opacity-50 cursor-not-allowed' : ''
                                }`}
                        >
                            Cancel
                        </button>
                        <button
                            ...
                            disabled={isLoading}
                            className={`flex-1 h-11 rounded-lg font-medium ${TAILWIND_COLORS.BTN_PRIMARY} ${isLoading ? 'opacity-50 cursor-not-allowed' : 'hover:opacity-90'
