...
const apiService = {
  ...
  certificateTemplates: "/certificate_templates/certificate_templates.php", // Used in CertificateGeneration.jsx - get all templates
  getCertificateTemplate: "/certificate_templates/certificate_templates.php", // For Manage Template - get single template by ID (use ?id=5)
  certificateTemplatesList: "/certificate_templates/certificate_templates.php", // Used in ManageTemplate.jsx and CertificateGeneration.jsx - get all templates
