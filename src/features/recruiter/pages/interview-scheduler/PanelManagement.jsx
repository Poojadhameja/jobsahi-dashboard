      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-5">
        ...
        <div className="bg-white rounded-lg border border-gray-200 p-5">
          <div className="mb-6">
            ...
            <p className="text-sm text-gray-600">Provide feedback for completed interviews</p>
          </div>
            ...
            <div className="space-y-4">
              {feedbackList.map((feedback) => (
                <div key={feedback.id} className="border border-gray-200 rounded-lg p-4">
                  <div className="mb-3">
                    <h4 className="font-semibold text-gray-900 mb-1">{feedback.candidate}</h4>
                    <p className="text-sm text-gray-600">{feedback.interviewDetails}</p>
                  </div>
